...
<head>
    ...
    <script type="text/javascript">
        ...
        })(window, document,'script','https://mc.yandex.ru/metrika/tag.js?id=105853734', 'ym');

        ym(105853734, 'init', {ssr:true, webvisor:true, clickmap:true, ecommerce:"dataLayer", accurateTrackBounce:true, trackLinks:true});
    </script>
    <noscript><div><img src="https://mc.yandex.ru/watch/105853734" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
    <!-- /Yandex.Metrika counter -->
</head>
...
<header class="header" id="header">
    <a href="<?= home_url(); ?>" class="header__logo">
        <img src="/wp-content/uploads/2025/11/logotip.svg" alt="logo">
    </a>
